/**
 * A speed-improved perlin and simplex noise algorithms for 2D/3D.
 *
...
// Base permutation table (size 256)
...
// Initialize with default seed 0 to match original behavior
seed(0);
...
/**
 * Default export keeps the same feel as the old `global.noise` object,
 * but as a proper TypeScript/ES module.
 */
